    ...
    var y = function () {
        ...
        return p(e, [{
            ...
            value: function () {
                ...
                t.id = 'nest-canvas'; // JARED ADDED THIS
                var body = document.body;
                var html = document.documentElement;
                var height = Math.max(body.scrollHeight, body.offsetHeight, html.clientHeight, html.scrollHeight, html.offsetHeight, this.el.clientHeight);
                return t.style.cssText = "display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:" + (e = this.c).zIndex + ";opacity:" + e.opacity, t.width = this.el.clientWidth, t.height = height, this.el.appendChild(t), t
            }
        }, {
            key: "requestFrame",
            value: function (e) {
